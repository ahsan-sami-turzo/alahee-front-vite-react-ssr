...
const HomePage = () => {
  ...
  const getFeaturedCategories = () => {
    axios
      ...
      .then((res) => res.data)
      .then((data) => setFeaturedCategories(data[0]))
  };
  ...
  const setFeatureProductValues = (data) => {
    if (data.length > 0) {
      ...
      if (bannerImages) setBannerImagesProducts(bannerImages.products);
      ...
      if (newForYou) {
        newForYou.products.sort((a, b) => parseFloat(b.product_id) - parseFloat(a.product_id));
      ...
      if (more) setmoreProducts(more.products);
      if (others) setOtherProductsDesk([...others.products.slice(0, 5)]);
      if (others) setOtherProductsMb([...others.products.slice(0, 6)]);
    }
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="Description"
          content="Online shopping center in Bangladesh. All kinds of products available here in alahee.com"
        />
        ...
        <div className="row">
          <div className="col-lg-3 col-md-12">
            <div className="d-none d-lg-block">
              {categories && <MainCategoriesSidebar categories={categories} />}
            </div>

            <div className="d-block d-lg-none mb-4">
              {categories && <CategoriesMb categories={categories} />}
            </div>
          </div>

          <div className="col-lg-9 col-md-12">
            <LazyLoad height={200} once>
              {mainSliderImages && <MainSlider images={mainSliderImages} />}
            </LazyLoad>
            <LazyLoad height={200} once>
              {bannerImagesProducts && (
            ...
            <div className="col-lg-6 col-md-12">
              <div className="row">
                <div className="col-12">
                  ...
                  <div className="float-right see-more">
                    <a
                      href={`/featureproducts/${newForYouProducts.feature_id}`}
                    >
                      See more
                    </a>
                  </div>
